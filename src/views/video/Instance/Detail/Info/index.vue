<template>
    <j-descriptions bordered>
        ...
        <!-- <j-descriptions-item label="注册时间">
            <iframe ref="myIframe" src="https://open.ys7.com/ezopen/h5/iframe?url=ezopen://open.ys7.com/482097123/1.live&autoplay=1&accessToken=at.7eplpc6g6gg941hx58nrr0hqddwmt16z-8hgkefk6i2-16xfeh5-wbo41ed6i" width="100%" height="100%"
    ...
    <iframe ref="myIframe" :src="instanceStore.current?.streamUrl" width="100%" height="100%"
            frameborder="0" allowfullscreen></iframe>
    <Config />
    <Tags
        v-if="
