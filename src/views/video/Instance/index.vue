...
const handleView = (id: string) => {
    menuStory.jumpPage('video/Instance/Detail', { id });
};
...
const activeAllDevice = () => {
    type.value = 'active';
    const activeAPI = `${BASE_API_PATH}/video-device-instance/deploy?:X_Access_Token=${LocalStore.get(
        TOKEN_KEY,
...
const syncDeviceStatus = () => {
    type.value = 'sync';
    const syncAPI = `${BASE_API_PATH}/video-device-instance/state/_sync?:X_Access_Token=${LocalStore.get(
        TOKEN_KEY,
